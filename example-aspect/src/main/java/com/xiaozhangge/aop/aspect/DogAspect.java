package com.xiaozhangge.aop.aspect;
...
public class DogAspect {
    ...
    @Pointcut("execution(public * com.xiaozhangge.aop.service.*.*(..))")
     ...
     * @param joinPoint
     */
    @Before("execution(* com.xiaozhangge.aop.service.*.*(..))")
     ...
     * @param returnVal
     */
    @AfterReturning(value = "execution(* com.xiaozhangge.aop.service.*.*(..))", returning = "returnVal")
     ...
     * @param e
     */
    @AfterThrowing(value = "execution(* com.xiaozhangge.aop.service.*.*(..))", throwing = "e")
     ...
     * @param joinPoint 可选
     */
    @After("execution(* com.xiaozhangge.aop.service.*.*(..))")
     ...
     * @throws Throwable
     */
    @Around("execution(* com.xiaozhangge.aop.service.*.*(..))")
