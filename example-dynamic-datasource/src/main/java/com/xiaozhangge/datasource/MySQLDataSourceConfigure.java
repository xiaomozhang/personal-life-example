...
import com.xiaozhangge.datasource.config.HikariMySQLConfig;
 ...
 */
@Configuration
@MapperScan(basePackages = "com.xiaozhangge.mapper.mysql", sqlSessionTemplateRef = "mysqlSqlSessionTemplate")
